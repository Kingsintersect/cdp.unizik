...
const announcements = [
  {
    ...
    date: "April 15, 2025",
    description:
      "Course registration for the 2025/2026 academic session is now active. All students are advised to pay their school fees and register their courses online via the portal to avoid late entry penalties.",
    icon: Calendar,
    type: "important",
  },
  {
    ...
    date: "April 12, 2025",
    description:
      "The University Senate invites submissions for the upcoming multidisciplinary symposium. Submit your abstracts to the faculty secretariat by May 30th, 2025.",
    icon: Award,
    type: "academic",
  },
  {
    ...
    date: "April 10, 2025",
    description:
      "The UNIZIK digital portal will be down for scheduled maintenance on April 20th. Please complete all pending online registrations before 2:00 AM to avoid data loss.",
    icon: AlertCircle,
    type: "alert",
  },
  {
    ...
    date: "April 8, 2025",
    description:
      "Great Zikites! Cast your votes for the Student Union Government elections. Voting will take place via the e-platform on April 25-26, 2025. Exercise your franchise!",
    icon: Users,
    type: "community",
  },
];
  ...
  return (
    <Card className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm dark:shadow-gray-700/30">
      <CardHeader className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-[#23608c] dark:text-blue-400">
          Announcements
        </h2>
        <Link
          href="#"
